...
class BoundaryROIHeads(StandardROIHeads):
    ...
    def _forward_mask(
        self, features: Dict[str, torch.Tensor], instances: List[Instances]) -> Union[Dict[str, torch.Tensor], List[Instances]]:
        """
        ...
        our_mask_features = mask_features[0]
        ...
        if self.training:
            ...
            return self.mask_head(mask_features, boundary_features, proposals,our_mask_features)
        else:
            ...
            return self.mask_head(mask_features, boundary_features, instances,our_mask_features)
